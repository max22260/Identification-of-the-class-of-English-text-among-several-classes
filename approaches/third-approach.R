# ====================================================================================================
# title: preprocssing data that given by stanfordCoreNLP stemmer  & fit bag Of word and calculate TF & reduction 
#        dim by remove sparce term fit deffirant type of classification algorithms     
#-----------------------------------------------------------------------------------------------------
...
setwd(dir = dir)
bbc.data.matrix <-read.csv(file = "../data/Dataset_StanfordCoreNLP.csv",header = TRUE)
colnames(bbc.data.matrix)[1:3] <- c("filename","content","class")
...
remove(train_matrix)
#--------------------------------------------------------------------------------------------------------
save(train_data_model,test_data_model,BagOW , file = "../data/approaches_data/third-approach//first-approach-data.RData")
#--------------------------------------------------------------------------------------------------------
...
third_approach <- Visualizing_Data.t_SNE(train_data_model , ClassNumber = 5)
...
confusionMatrix(testpred,test_data_model[,1],positive = "positive", dnn = c ("prediction","true"))


# second accuracy

mmetric(testpred,test_data_model[,1],c("ACC","TPR","PRECISION","F1"))
...
#---------------------------------------------------------------------------------------
saveRDS(naiveB_model,file = "../data/approaches_data/third-approach//naiveB_model.rda")
saveRDS(dtree_model,file = "../data/approaches_data/third-approach//dtree_model.rda")
saveRDS(rf_model,file = "../data/approaches_data/third-approach/rf_model.rda")
saveRDS(svm,file = "../data/approaches_data/third-approach/svm.rda")
#----------------------------------------------------------------------------------------
...
save(accuracy,file = "../data/approaches_data/third-approach/accuracy.RData")
#-------------------------------------------------------------------------------------------
