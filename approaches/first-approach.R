...
#---------------------------------------------------------------------------------------
saveRDS(naiveB_model,file = "../data/approaches_data/first_approach/naiveB_model.rda")
saveRDS(dtree_model,file = "../data/approaches_data/first_approach/dtree_model.rda")
saveRDS(rf_model,file = "../data/approaches_data/first_approach/rf_model.rda")
saveRDS(svm,file = "../data/approaches_data/first_approach/svm.rda")
#----------------------------------------------------------------------------------------
...
save(accuracy,file = "../data/approaches_data/first_approach/accuracy.RData")
#-------------------------------------------------------------------------------------------
