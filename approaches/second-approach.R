# ====================================================================================================
# title: preprocssing & fit stemming & fit bag Of word and calculate TF & reduction dim by remove sparce term fit 
...
remove(train_matrix)
#--------------------------------------------------------------------------------------------------------
save(train_data_model,test_data_model,BagOW , file = "../data/approaches_data/second-approach/second-approach-data.RData")
#--------------------------------------------------------------------------------------------------------
...
second_approach <- Visualizing_Data.t_SNE(train_data_model , ClassNumber = 5)
...
#---------------------------------------------------------------------------------------
saveRDS(naiveB_model,file = "../data/approaches_data/second-approach/naiveB_model.rda")
saveRDS(dtree_model,file = "../data/approaches_data/second-approach/dtree_model.rda")
saveRDS(rf_model,file = "../data/approaches_data/second-approach/rf_model.rda")
saveRDS(svm,file = "../data/approaches_data/second-approach/svm.rda")
#----------------------------------------------------------------------------------------
...
save(accuracy,file = "../data/approaches_data/second-approach/accuracy.RData")
#-------------------------------------------------------------------------------------------
