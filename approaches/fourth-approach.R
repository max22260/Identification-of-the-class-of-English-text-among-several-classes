# ====================================================================================================
# title: preprocssing & fit stemming & fit bag Of word and fit TFIDF & reduction dim by remove sparce term fit 
...
train_dtm <-preProcess_TFIDF(row.data = train_dataset$content ,stopword.dir = "../data/stopword.txt",BagOfWord = NULL , TRUE)

train_dtm <- removeSparseTerms(train_dtm,0.993)
BagOW <- findFreqTerms(train_dtm)
test_dtm <-preProcess_TFIDF(row.data = test_dataset$content ,stopword.dir = "../data/stopword.txt",BagOfWord = BagOW , TRUE )
...
remove(train_matrix)
#--------------------------------------------------------------------------------------------------------
save(train_data_model,test_data_model,BagOW , file = "../data/approaches_data/fourth approach//fourth-approach-data.RData")
#--------------------------------------------------------------------------------------------------------
...
fourth_approach <- Visualizing_Data.t_SNE(train_data_model , ClassNumber = 5)
...
#---------------------------------------------------------------------------------------
saveRDS(naiveB_model,file = "../data/approaches_data/fourth approach//naiveB_model.rda")
saveRDS(dtree_model,file = "../data/approaches_data/fourth approach//dtree_model.rda")
saveRDS(rf_model,file = "../data/approaches_data/fourth approach//rf_model.rda")
saveRDS(svm,file = "../data/approaches_data/fourth approach//svm.rda")
#----------------------------------------------------------------------------------------
...
save(accuracy,file = "../data/approaches_data/fourth approach/accuracy.RData")
#-------------------------------------------------------------------------------------------
