...
train_dtm <-preProcess_TFIDF(row.data = train_dataset$content ,stopword.dir = "test.txt",BagOfWord = NULL , TRUE)
...
subset <- cutoff.k(chi_square , 500)
...
subset_info <- cutoff.k(IG_weight,1000)
