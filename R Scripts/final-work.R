# ====================================================================================================
# title: final work by use the fourth-approach & and use cross validation to get best sample of data 
#         and evaluate models 
#-----------------------------------------------------------------------------------------------------
# author:   ahmed nagy radwan
#-----------------------------------------------------------------------------------------------------
# summary: fit preprocessing and bag of word and fit and calculate TFIDF , use remove sparce term 
#          function to remove  noise feature and fit classification algorithm ,and calculate accuracy 
#          for every model
#-----------------------------------------------------------------------------------------------------
...
remove(train_matrix)
#----------------------------------------------------------------------------------------------------
save(train_data_model,BagOW,file = "../data/all_data_matrix.RData")
#----------------------------------------------------------------------------------------------------
library(caret)
...
save(acc_matrix,acc_plot,file = "../data/10_flods_crossValidation_result.RData")
